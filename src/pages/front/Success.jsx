...
function Success() {
  ...
  const { getOrder, orderData, isLoading } = useOutletContext();
  const orderIdData = { orderId: orderId, source: "success" };
          ...
          <div className="row">
            <div className="col-md-6">
              ...
              <p className="text-muted">
                親愛的顧客，感謝您在本平台訂購商品。我們非常感激您對我們的信任和支持，讓我們有機會為您提供優質的商品和服務。
              </p>
              <p className="text-muted">
                感謝您選擇本平台，祝您購物愉快，生活愉快！
              </p>
              ...
              <div className="card rounded-0 py-4">
                ...
                <div className="card-body px-4 py-0">
                  <ul className="list-group list-group-flush">
                    {Object.values(orderData?.order?.products || {}).map(
                      (item) => {
                        return (
